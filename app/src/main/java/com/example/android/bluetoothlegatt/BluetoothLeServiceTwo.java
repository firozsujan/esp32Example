 ...
 */
public class BluetoothLeServiceTwo extends Service {
    private final static String TAG = BluetoothLeServiceTwo.class.getSimpleName();
    ...
    public final static UUID UUID_ESP32 =
            UUID.fromString(SampleGattAttributes.UUID_ESP32);
...
//            broadcastUpdate(ACTION_DATA_AVAILABLE, characteristic, gatt.getDevice().getAddress());
    ...
    private void broadcastUpdate(final String action,
                                 final BluetoothGattCharacteristic characteristic, String deviceAddress) {
        final Intent intent = new Intent(action);

        // This is special handling for the Heart Rate Measurement profile.  Data parsing is
        // carried out as per profile specifications:
        // http://developer.bluetooth.org/gatt/characteristics/Pages/CharacteristicViewer.aspx?u=org.bluetooth.characteristic.heart_rate_measurement.xml
        if (UUID_ESP32.equals(characteristic.getUuid())) {
    ...
    public class LocalBinder extends Binder {
        BluetoothLeServiceTwo getService() {
            return BluetoothLeServiceTwo.this;
        }
    }
...
//            }
    ...
    public List<BluetoothGattService> getSupportedGattServices() {
        ...
        List<BluetoothGattService> gattServiceList = new ArrayList<>();
        ...
        for (BluetoothGattService gattService : gattServices) {
            ...
            for (BluetoothGattCharacteristic gattCharacteristic : gattCharacteristics) {
                ...
                if (uuid.equalsIgnoreCase(SampleGattAttributes.CLIENT_CHARACTERISTIC_CONFIG)) {
                    mNotifyCharacteristic = gattCharacteristic;

                    mBluetoothGatt.setCharacteristicNotification(gattCharacteristic, true);
                    Log.i("BluetoothLeService", "setCharacteristicNotification : " + uuid);
                    UUID magic_uuid = UUID.fromString(SampleGattAttributes.UUID_ESP32);
